...
public class FormPage extends ElementsForm {
	...
	public void preencherDataNascimento(String dia, String mes, String ano) {

		cc.selecionarData(dataNascimento, dia, mes, ano);
	...
	public void preencherHobby(String hobby) {
		if (hobby.equalsIgnoreCase("S")) {
			cc.clicarComScroll(checkHobbyEsportes);
	...
	public void escolherUpdate(String caminho) {

		cc.uploadArquivo(uploadArquivo, caminho);
	...
	public void clicarSubmenter() {
		...
		cc.clicarComScroll(botaoEnviar);
	}
	
	public void ValidarMensagem(String msn) {

		cc.validarMensagem(mensagemSucesso, msn);
	}

	public void clicarFechar() {

		cc.clicarComScroll(botaoClose);
	}
