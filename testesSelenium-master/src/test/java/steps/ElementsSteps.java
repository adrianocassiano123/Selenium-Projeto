...
public class ElementsSteps {
	...
	public void deleto_registro_criado() throws Throwable {

		elementsPage.clicarBtnDeletar();
	}

	@Quando("crio os seguintes registros:")
	public void criar_os_registros_com_dados(DataTable dataTable) {
	    elementsPage.criar12Registros(dataTable);
	}

	@Então("deleto apenas os registros criados")
	public void deleto_apenas_os_registros_criados() {
		elementsPage.deletarUltimosRegistros(12);
	}
